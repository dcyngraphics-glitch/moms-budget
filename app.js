...
function renderDashboard() {
  ...
  const monthPaidBills = appData.bills
    .filter(b => isSameMonth(b.dueDate, viewYear, viewMonth) && b.paid)
    .reduce((sum, b) => sum + (Number(b.amount) || 0), 0);

  const remaining = monthIncome - monthPaidBills - monthExpenses;
      ...
      <div class="summary-hero">
        ...
        <div class="summary-row">
          <div class="summary-card bills">
            ...
            <div class="value" data-tick-start="0" data-tick-end="${monthPaidBills}">${formatCurrency(monthPaidBills)}</div>
          </div>
